...
const giveArrayChangedParams_1 = require("../../shared/helpers/giveArrayChangedParams");
let TaskService = class TaskService {
    ...
    patch(_a) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const text = (0, giveArrayChangedParams_1.giveArrayChangedParams)(task, Object.assign(Object.assign({}, rest), { status: section.name }));
            yield this.historyService.createHistory({
                board: section.board,
                task,
                text,
